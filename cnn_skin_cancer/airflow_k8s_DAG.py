...
#     deploy_type="env", deploy_target="AWS_BUCKET", secret=secret_name, key="AWS_BUCKET"
# )
# SECRET_AWS_REGION = Secret(
#     deploy_type="env", deploy_target="AWS_REGION", secret=secret_name, key="AWS_REGION"
# )
...
# tolerations = [
#     k8s.V1Toleration(
#         key="dedicated", operator="Equal", value="t3_large", effect="NoSchedule"
#     )
# ]
...
#             y_test_data_path,
#         ) = data_preprocessing(
#             mlflow_experiment_id=mlflow_experiment_id, aws_bucket=aws_bucket
#         )
...
#         mlflow_experiment_id: str, model_class: str, model_params: dict, input: dict
#     ) -> dict:
#         """
#         Train a model.
...
#         train_data_basic: dict, train_data_resnet50: dict, train_data_crossval: dict
#     ) -> dict:
#         """
...
#         input=preprocessed_data,
#     )
#     compare_models_dict = compare_models_op(
#         train_data_basic, train_data_resnet50, train_data_crossval
#     )
